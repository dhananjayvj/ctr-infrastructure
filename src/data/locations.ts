...
export const projectLocations: ProjectLocation[] = [
  { id: 'agrarian-retreat', name: 'The Agrarian Retreat', category: 'Residential', city: 'Thiruchangode', state: 'Tamil Nadu', coordinates: { lat: 11.369390, lng: 78.030553, dms: `11° 22' 9.8051" N, 78° 1' 49.9897" E` } },
  { id: 'riverside-farmhouse', name: 'Riverside Farmhouse', category: 'Residential', city: 'Bhavani', state: 'Tamil Nadu', coordinates: { lat: 11.584252, lng: 77.718055, dms: `11° 35' 3.3072" N, 77° 43' 4.998" E` } },
  ...
  { id: 'grand-pavilion', name: 'The Grand Pavilion Venue', category: 'Hospitality', city: 'Tiruppur', state: 'Tamil Nadu', coordinates: { lat: 11.145816, lng: 77.387745, dms: `11° 8' 44.9376" N, 77° 23' 15.882" E` }, highlight: true },
  { id: 'urban-courtyard', name: 'Urban Courtyard House', category: 'Residential', city: 'Tiruppur', state: 'Tamil Nadu', coordinates: { lat: 11.145283, lng: 77.387943, dms: `11° 8' 43.0188" N, 77° 23' 16.5948" E` } },
  ...
  { id: 'minimalist-haven', name: 'Minimalist Canopy Haven', category: 'Residential', city: 'Tiruppur', state: 'Tamil Nadu', coordinates: { lat: 11.197180, lng: 77.257582, dms: `11° 11' 49.848" N, 77° 15' 27.2952" E` } },
  ...
  { id: 'eco-resort-spa', name: 'Eco-Resort & Wellness Retreat', category: 'Hospitality', city: 'Coimbatore', state: 'Tamil Nadu', coordinates: { lat: 11.0168, lng: 76.9558, dms: `11° 1' 0.5" N, 76° 57' 20.9" E` }, highlight: true },
  ...
  { id: 'educational-block', name: 'Primary Educational Block', category: 'Institutional', city: 'Udumalapettai', state: 'Tamil Nadu', coordinates: { lat: 10.585, lng: 77.247, dms: `10° 35' 6.0" N, 77° 14' 49.2" E` } },
  { id: 'campus-masterplan', name: 'Campus Masterplan & Academic Block', category: 'Institutional', city: 'Coimbatore', state: 'Tamil Nadu', coordinates: { lat: 10.944, lng: 76.912, dms: `10° 56' 38.4" N, 76° 54' 43.2" E` } },
  ...
  { id: 'sacred-heritage-complex', name: 'Sacred Heritage Complex', category: 'Institutional', city: 'Talakad', state: 'Karnataka', coordinates: { lat: 12.22, lng: 77.03, dms: `12° 13' 12.0" N, 77° 1' 48.0" E` } },
